/**
 ...
 function main(params) {
   return new Promise(function (resolve, reject) {
     ...
     assert(params.collection_id_english, 'params.collection_id_english cannot be null');
     assert(params.collection_id_german, 'params.collection_id_german cannot be null');
     ...
     if(params.output.hasOwnProperty('action') && params.output.action.hasOwnProperty('call_discovery')) {
         ...
         if(params.input.hasOwnProperty('language_detected')) {
             ...
             if (params.input.language_detected == 'de') {
                 collection_id = params.collection_id_german;
             }
